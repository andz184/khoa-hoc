        ...
        <div class="row">
                ...
                <div class="feature_card">
                    <div class="feature_icon_wrapper">
                        <div class="feature_icon">
                            <img src="{{asset('assets/img/anh169.png')}}" alt="Cho người mới">
                        </div>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="feature_card">
                    <div class="feature_icon_wrapper">
                        <div class="feature_icon">
                            <img src="{{asset('assets/img/anh168.png')}}" alt="Chuyên gia nâng cao">
                        </div>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="feature_card">
                    <div class="feature_icon_wrapper">
                        <div class="feature_icon">
                            <img src="{{asset('assets/img/anh167.png')}}" alt="Hỗ trợ">
                        </div>
