...
/* Add top and bottom sections with dark background */
...
.lesson-item:hover {
    ...
    box-shadow: 0 15px 30px rgba(138, 76, 191, 0.2);
...
.lesson-item:hover .lesson-content h5 {
    color: #CD9CFF;
    text-shadow: 0 0 10px rgba(205, 156, 255, 0.3);
}
...
.lesson-item:hover .lesson-content p {
...
.lesson-objectives:hover {
    background: #1a103c;
    box-shadow: 0 8px 20px rgba(138, 76, 191, 0.15);
...
.lesson-objectives strong {
    ...
    margin-bottom: 8px;
    font-size: 1.05rem;
    text-shadow: 0 0 10px rgba(205, 156, 255, 0.2);
}
...
.form-control:focus {
    background: #30164e;
    border-color: #8a4cbf;
    box-shadow: 0 0 0 0.2rem rgba(138, 76, 191, 0.25);
    color: #fff;
}
...
.enroll-btn:hover {
    transform: translateY(-2px);
    box-shadow: 0 5px 15px rgba(138, 76, 191, 0.3);
}
...
.form-control {
    border: 1px solid rgba(26, 16, 60, 0.2);
    border-radius: 8px;
    padding: 0.75rem 1rem;
    transition: all 0.3s ease;
}
...
.btn-primary:hover {
    background: linear-gradient(135deg, #7a3caf 0%, #bd8cef 100%);
    transform: translateY(-2px);
    box-shadow: 0 5px 15px rgba(138, 76, 191, 0.3);
}
...
/* Đảm bảo nội dung hiển thị trên particles */
.course_details_area {
    position: relative;
    z-index: 1;
}
...
>>>>>>> 3065b4f18668ef30e55ccec32b5ad2bc79944dd9
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.openEnrollModal = function() {
        console.log('openEnrollModal called');
...
<<<<<<< HEAD
    // Add pulse animation to price - only once when page loads
...
window.addEventListener('unload', function() {
    ...
    document.removeEventListener('touchstart', function() {}, {passive: true});
    document.removeEventListener('touchmove', function() {}, {passive: true});
