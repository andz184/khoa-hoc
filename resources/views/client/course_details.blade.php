...
.lesson-item::before {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(45deg, rgba(138, 76, 191, 0.1), rgba(233, 30, 99, 0.1));
    opacity: 0;
...
.lesson-item:hover {
    ...
    border-color: rgba(138, 76, 191, 0.5);
    background: #1a103c;
}
...
.lesson-objectives:hover::before {
    opacity: 1;
}
